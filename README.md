...
-   Process: It produces the TFD computational complexity measured in terms of
    ...
    *comtime_ed.mat*, *comtime\_bjd.mat*, *comtime_bd.mat*, *comtime_mbd.mat*,
...
-   *filter\_tfd.m*: It filters the WVD using the kernels listed in
    *tf_kernel.m*.
...
2.  *MP:* This folder holds the MP parameters and MPD of the example signal
    generated by the demo script *Demo_2_tfd_comparison.m* in *MP\_example.mat*
